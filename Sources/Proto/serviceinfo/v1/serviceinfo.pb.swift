...
extension Io_Altessa_Serviceinfo_V1_ServiceInfo: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    ...
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      while let fieldNumber = try decoder.nextFieldNumber() {
        ...
        case 4: try { try decoder.decodeSingularBoolField(value: &_storage._isLeader) }()
        ...
        case 7: try { try decoder.decodeSingularStringField(value: &_storage._buildTime) }()
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      ...
      if _storage._isLeader != false {
        try visitor.visitSingularBoolField(value: _storage._isLeader, fieldNumber: 4)
      }
      ...
      if !_storage._buildTime.isEmpty {
        try visitor.visitSingularStringField(value: _storage._buildTime, fieldNumber: 7)
      }
  ...
  public static func ==(lhs: Io_Altessa_Serviceinfo_V1_ServiceInfo, rhs: Io_Altessa_Serviceinfo_V1_ServiceInfo) -> Bool {
    if lhs._storage !== rhs._storage {
      let storagesAreEqual: Bool = withExtendedLifetime((lhs._storage, rhs._storage)) { (_args: (_StorageClass, _StorageClass)) in
        ...
        if _storage._isLeader != rhs_storage._isLeader {return false}
