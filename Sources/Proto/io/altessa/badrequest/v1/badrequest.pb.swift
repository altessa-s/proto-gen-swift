...
public struct Io_Altessa_Badrequest_V1_FieldPathComponent: Sendable {
  ...
  public var repeatedField: Bool {
    get {return _repeatedField ?? false}
    set {_repeatedField = newValue}
  }
  /// Returns true if `repeatedField` has been explicitly set.
  public var hasRepeatedField: Bool {return self._repeatedField != nil}
  /// Clears the value of `repeatedField`. Subsequent reads from it will return its default value.
  public mutating func clearRepeatedField() {self._repeatedField = nil}
  ...
  fileprivate var _repeatedField: Bool? = nil
...
extension Io_Altessa_Badrequest_V1_FieldPathComponent: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    ...
    6: .standard(proto: "repeated_field"),
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 6: try { try decoder.decodeSingularBoolField(value: &self._repeatedField) }()
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    try { if let v = self._repeatedField {
  ...
  public static func ==(lhs: Io_Altessa_Badrequest_V1_FieldPathComponent, rhs: Io_Altessa_Badrequest_V1_FieldPathComponent) -> Bool {
    ...
    if lhs._repeatedField != rhs._repeatedField {return false}
